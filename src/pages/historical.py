...
print('pnl: ', dff.pnl_plus[dff.day_o_week == 6].sum())
        ...
        dbc.CardBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    html.Br(),
                    create_titled_card('Quarterly Performance Overview', dash_table.DataTable(
                                                            id='table-1-2',
...
def update_page1(y2018, y2019, y2020, y2021, y2022, y2023, total):
   ...
   #     return dash.no_update
    ...
    #exclude weekends
    dfc['pnl_ac'][(dfc.day_o_week == 5) | (dfc.day_o_week == 6)] = 0
    ...
    figln = hl.generate_line_shaded(dfc, plot_title)  
  
    performance = hl.Performance(dfc.pnl_ac)
